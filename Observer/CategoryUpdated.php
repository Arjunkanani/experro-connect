...
class CategoryUpdated implements ObserverInterface
{
    /**
     * @var CustomHelper
     */
    ...
    public function execute(Observer $observer)
    {
        ...
        try {
            ...
            $storeId = $observer->getCategory()->getStoreId();
            ...
            $eventType = 'Category';
            $eventAction = 'Updated';
            $experroEndPointResponse = $this->customHelper->experroEndPoint($storeCode,$eventType,$eventAction,$categoryId);
            ...
            $this->customLogger->info('Category '.$categoryId.' got updated.');
            ...
            if ($experroApiResponse == 500) {
                try {
                    ...
                    $existingAttempt = $attemptCollection
                        ->addFieldToFilter('related_id', $categoryId)
                    ...
                    // Success message
                    $this->customLogger->info('Data has been successfully inserted in attempt table for category not sent to experro.');
                } catch (\Exception $e) {
                    // Error message
