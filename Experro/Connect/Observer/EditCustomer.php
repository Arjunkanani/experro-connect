...
class EditCustomer implements ObserverInterface
{
    ...
    { 
        ...
        try {
            ...
            $eventType = 'Customer';
            $eventAction = 'Updated';
            $experroEndPointResponse = $this->customHelper->experroEndPoint($storeCode,$eventType,$eventAction,$customerId);
            ...
            $this->customLogger->info('Customer '.$customerId.' got updated.');
            ...
            if ($experroApiResponse == 500) {
                try {
                    ...
                    $existingAttempt = $attemptCollection
                        ->addFieldToFilter('related_id', $customerId)
                    ...
                    // Success message
                    $this->customLogger->info('Data has been successfully inserted in attempt table for customer not sent to experro.');
                } catch (\Exception $e) {
                    // Error message
